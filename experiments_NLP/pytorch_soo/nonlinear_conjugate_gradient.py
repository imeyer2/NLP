...
class NonlinearConjugateGradient(Optimizer):
    ...
    def step(self, closure: Callable):
        ...
        # print(self.param_groups, flush = True)
        ...
        # print(f"Learning rate of optimizer is {lr}")
        # print(f"The max newton of the optimizer is {max_newton}")
        # print(f"The abs newton toleratance is {abs_newton_tol}")
        # print(f"The relative newton tolerance is {rel_newton_tol}")
        # print(f"the line search spec is {line_search_spec}")
        ...
        with torch.no_grad():
            ...
            def F(y):
                ...
                --Parameters--
                `y` : torch.tensor vector representing the parameters"""
                nonlocal orig_loss
                x = torch.clone(y)
                # for element in x:
                #     print(element)
    ...
    def _backtracking_line_search(
        ...
        for _ in range(max_searches):
            ...
            # print(f"Maximum number of line searches ({max_searches}) reached!")
            # time.sleep(1)
            xk1 = x_new
            new_loss = f(xk1)
